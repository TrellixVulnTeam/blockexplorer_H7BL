...
//gauge.js
//TO DO сделать динамическое распределение цветов на спидометре, чтобы красные не занимал 90% объема (?)
//TO DO запросить данные о средних показателях загрузки мемпула
//TO DO сделать кнопки (снизу) на спидометре: онлайн (проверить количество запросов в день), 7 дней и 30 дней
//TO DO сделать переход по ссылке на график
